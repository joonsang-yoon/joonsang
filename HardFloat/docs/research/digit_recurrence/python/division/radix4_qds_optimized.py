...
def remove_overlaps(d_list, min_t_list, max_t_list):
    for i in range(len(d_list) - 1):
        if d_list[i + 1] - d_list[i] == 0:
            if max_t_list[i + 1] - min_t_list[i] == 2:
                if max_t_list[i + 1] % 2 == 0:
                    max_t_list[i + 1] -= 1
                else:
                    min_t_list[i] += 1
                if min_t_list[i] % 4 == 0:
                    ...
                    min_t_list[i] += 2
            elif max_t_list[i + 1] - min_t_list[i] == 1:
                if max_t_list[i + 1] % 2 == 0:
                    max_t_list[i + 1] -= 1
                    min_t_list[i] += 1
                else:
                    if min_t_list[i] % 4 == 0:
                        ...
                        min_t_list[i] += 2
            elif max_t_list[i + 1] - min_t_list[i] == 0:
                if max_t_list[i + 1] % 2 == 0:
                    max_t_list[i + 1] -= 1
                else:
                    min_t_list[i] += 1
                ...
                print(f"Error: {d_list[i], max_t_list[i+1], min_t_list[i]}")
...
def plot_quotient_regions_no_overlap(D, T, q, quadrants):
    ...
    filename = f"radix4_qds_optimized_{quadrants}.png"
...
def main():
    try:
        ...
        plot_quotient_regions_no_overlap(D, T, q_no_overlap, "quadrants_1_4")

        # Plot the results for quadrants 2 and 3
        plot_quotient_regions_no_overlap(D, T, q_no_overlap, "quadrants_2_3")
